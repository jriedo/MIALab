...
\subsection{Dataset}
\TODO{resolution of images/slices}
...
\FIXME{The split points are called nodes and are pre-defined hyperparameters.} The depth of the trees can be regulated by the chosen number of tree nodes. High numbers of trees improve the accuracy until a certain point, but increases the computational costs due the learning of the additional trees. Bias of the trees can be reduced by choosing higher node numbers.
