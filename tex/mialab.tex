...
\begin{figure}[h]
	...
	\caption{Comparison of the importance of the individual features for different algorithms. Each algorithm was trained on the full training set of 70 samples and tested on the 30 samples of the test set. The dice score of each algorithm is calculated separately for the three tissue types. W: WM, G: GM, C: CSF.}
	\label{FeatEval} 
\end{figure}
