...
\mulrow{3}{Coordinates only\\(f1-f3)}
	& 3		&	{-}		& {-}	& {0.70/0.55/0.41}	& {-}	& {0.59/0.52/0.0}	& {-}\\
	& 12		&	{-}		& {-}	& {0.74/0.63/0.56}	& {-}	& {0.59/0.57/0.0}	& {-}\\
	& 70		&	{-}		& {-}	& {0.77/0.71/0.62}	& {-}	& {0.60/0.58/0.31}	& {-}\\
\midrule
\mulrow{3}{All non-coordinates \\(f4-f7)}
	& 3		&	{-}		& {-}	& {0.85/0.80/0.45}	& {-}	& {0.84/0.79/0.0}	& {-}\\
	& 12		&	{-}		& {-}	& {0.85/0.81/0.45}	& {-}	& {0.85/0.80/0.45}	& {-}\\
	& 70		&	{-}		& {-}	& {0.85/0.81/0.54}	& {-}	& {0.85/0.80/0.44}	& {-}\\
\bottomrule
\end{tabular*}
\begin{tablenotes}
